...
class MentorDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center( // Membuat semua elemen ke tengah
        child: Padding(
          padding: EdgeInsets.all(16),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center, // Posisi ke tengah
            crossAxisAlignment: CrossAxisAlignment.center, // Posisi horizontal ke tengah
            children: [
              CircleAvatar(
                radius: 50,
                backgroundImage: AssetImage(mentor.image),
...
class ChatScreen extends StatelessWidget {
  ...
  ChatScreen({required this.mentor});
