...
class _PregnancyTrackerScreenState extends State<PregnancyTrackerScreen> {
  ...
  Widget _getBabyImage() {
    // This is a simplified representation - in a real app, you'd use actual
    // images for each week or a more sophisticated drawing mechanism
    return Container(
      height: 200,
      child: Stack(
  ...
  Widget _getBabyIllustration() {
    // Custom illustration based on week
